"""
Day15: fine-tune a tiny BERT model for SemEval-2016 Task 6 stance classification.

This is a small baseline for learning:
Target + Tweet -> BERT -> AGAINST / FAVOR / NONE
"""
